<?php
$title = 'Portfolio - Jean Forteroche';
ob_start();
?>
                ...
                <aside class="col-sm-4 col-sm-8">
                    ...
                    <div class="widget tags">
                        ...
                        <ul class="tag-cloud tech">
                            ...
                            <li><img src="./public/images/languages/php7.png" alt="PHP7 Logo"> PHP7 </li>
                            <li><img src="./public/images/languages/mysql.png" alt="MYSQL Logo"> MYSQL </li>
                        </ul>
                    </div>
