...
?>
    ...
    devPack1Label
    I want the $XXX pack!
    action="index.php?action=sendMessage pour que ça envoi le formulaire avec la bonne demande (website / store ou les 2)
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="contactForm" action="index.php?action=sendMessage" method="post">
                        ...
                        <div class="row">
                            <div class="form-group col-md-12">
                                <small>*No extra requests will be accepted. Need something not included in this pack ?
                                    <br>Ask for a <a href="quote-Web.html"><strong>custom quote</strong></a> !</small>
                            </div>
                        </div>
