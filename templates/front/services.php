                                ...
                                <div class="pricing_item">
                                    ...
                                    <div class="pricing_body bg-white p-top-110 p-bottom-60">
                                        ...
                                        <div class="text-center">
                                            <a id="devpack1Btn" data-toggle="modal" data-target="#devPack1"
                            ...
                            <div class="col-md-3 col-sm-12 flip-in">
                                <div class="pricing_item">
                                    ...
                                    <div class="pricing_body bg-white p-top-110 p-bottom-60">
                                        ...
                                        <div class="text-center">
                                            <a id="devpack2Btn" data-toggle="modal" data-target="#devPack2"
                                                class="btn btn-princing">I want this!</a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-3 col-sm-12 flip-in">
                                <div class="pricing_item">
                                    ...
                                    <div class="pricing_body bg-white p-top-110 p-bottom-60">
                                        ...
                                        <div class="text-center">
                                            <a id="devpack3Btn" data-toggle="modal" data-target="#devPack3"
                                                class="btn btn-princing">I want this!</a>
                                        </div>
                                    </div>
                                </div>
...
<!-- Modal Box to send the pack quote -->
                ...
                <form class="contactForm" action="index.php?action=sendPackQuote" method="post" enctype="multipart/form-data">
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" id="packName" name="packName" value="" readonly >
                        </div>
                        <div class="form-group col-md-6">
...
//Populate modal box packname / price fields depending on chosen pack - needs to stay here because uses PHP variables
    $("#devpack1Btn").on("click",function(){
        $(".modal").attr("id","devPack1");
        $(".modal-title").text("I want the <?= $packName1 ?> pack!");
        $("#packName").val("<?= $packName1 ?>");
        $("#price").val("<?= $packPrice1 ?>");
    });

    $("#devpack2Btn").on("click",function(){
        $(".modal").attr("id","devPack2");
        $(".modal-title").text("I want the <?= $packName2 ?> pack!");
        $("#packName").val("<?= $packName2 ?>");
        $("#price").val("<?= $packPrice2 ?>");
    });

    $("#devpack3Btn").on("click",function(){
        $(".modal").attr("id","devPack3");
        $(".modal-title").text("I want the <?= $packName3 ?> pack!");
        $("#packName").val("<?= $packName3 ?>");
        $("#price").val("<?= $packPrice3 ?>");
        });
</script>
<?php
